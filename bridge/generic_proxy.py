...
from generic_clients import GenericXmppClient, GenericMqttClient
...
class BridgeDaemon():
    def run(self):
        ...
        xmppClient = GenericXmppClient(xmpp_server, opts.xmpp_node, opts.path)
        mqttClient = GenericMqttClient(mqtt_server)
